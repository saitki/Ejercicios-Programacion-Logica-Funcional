...
peliculas_mayor_a_8 = list(filter(lambda x: float(x["CalificaciónIMDB"]) >= 8.0, lista_peliculas))
peliculas_titulo_calificacion = list(map(lambda t: {"titulo": t["Titulo"], "calificacion": t["CalificaciónIMDB"]}, peliculas_mayor_a_8))
print(peliculas_mayor_a_8)
print(peliculas_titulo_calificacion)